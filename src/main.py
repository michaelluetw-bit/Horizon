...
def main():
    ...
    parser.add_argument("--target-date", help="Verified YYYY-MM-DD date for generated daily artifacts")
    ...
    try:
        ...
        asyncio.run(orchestrator.run(force_hours=args.hours, target_date=args.target_date))
