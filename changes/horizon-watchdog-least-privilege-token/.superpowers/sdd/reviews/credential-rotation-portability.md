...
- The previous revision 3 receipt was invalidated as expected when the plan revision changed; its detailed credential/runtime report remains preserved separately.
